...
func GeneratePrompt(explanationStyle string) string {
	...
	if explanationStyle == "professional" {
		...
		styleInstruction = "请使用通俗易懂的大白话进行解读，就像医生给邻居老奶奶解释一样。尽量避免晦涩的专业术语，如果必须使用，请配合生活中的比喻来帮助理解。重点在于让普通人听懂这个指标意味着什么。"
	}

	var summaryStyle, explanationWord string
	...
	promptText := fmt.Sprintf(`
          ...
          "abnormalities": [
            {
              ...
              "reference": "参考范围",
              "status": "偏高/偏低/阳性/异常",
              "explanation": "解读内容：这个指标代表什么？（请严格遵循上述的'%s'风格要求）",
      ...
      `, styleInstruction, summaryStyle, explanationWord)
